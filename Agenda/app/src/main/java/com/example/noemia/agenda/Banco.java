...
/**
 * Created by Noemia on 15/02/2016.
 */
  public class Banco extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE contato(_id INTEGER PRIMARY KEY  AUTOINCREMENT,nome TEXT, mumero TEXT, imagem integer)";
        db.execSQL(sql);
    }
    ...
    public int updateLanche(Contato contato) {
